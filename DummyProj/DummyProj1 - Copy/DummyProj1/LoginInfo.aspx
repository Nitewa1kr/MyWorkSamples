...
<body>
    ...
    <table>
        <tr>
            <td>
                <asp:Label ID="S_ID" runat="server" Text="STUDENT NUM"></asp:Label>
            </td>
            <td>
                <asp:Label ID="lblS_NUM" runat="server"></asp:Label>
            </td>
        </tr>
        <tr>
            <td>
        ...
        <tr>
            <td>
                <asp:Label ID="sdob" runat="server" Text="STUDENT DOB"></asp:Label>
            </td>
            <td>
                <asp:TextBox ID="txtsDOB" TextMode="Date" runat="server"></asp:TextBox>
            </td>
        </tr>
        <tr>
            <td colspan="2">
        ...
        <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" CellPadding="4" ForeColor="#333333" GridLines="None" OnSelectedIndexChanged="GridView1_SelectedIndexChanged" AllowSorting="True" DataKeyNames="S_ID,P_ID,D_ID" DataSourceID="SqlDataSource1">
        ...
        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString %>" SelectCommand="SELECT Student_Name.S_ID, Student_Name.STUDENT_NUM, Student_Name.STUDENT_NAME, Student_Pass.P_ID, Student_Pass.PASSWORD, Student_DOB.D_ID, Student_DOB.DOB FROM Student_Name INNER JOIN Student_DOB ON Student_Name.S_ID = Student_DOB.D_ID CROSS JOIN Student_Pass WHERE S_ID = P_ID"></asp:SqlDataSource>
    </form>
</body>
</html>
